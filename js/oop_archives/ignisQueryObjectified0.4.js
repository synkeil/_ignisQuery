function $(dad, options , son){ //the selection
  options = options || {};
...
test10K($('#firstSection',{}, 'div').get(),0);

$('span', {parentIndex:0}).append('fuckoff');



// $('.div',{parentIndex:2}).attr('class', 'added');
